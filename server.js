...
app.post('/login', (req, res) => {
    ...
    if (username === 'admin' && password === '0410') {
        console.log("Admin logged in successfully"); // Log successful login
        return res.status(200).send({ message: "Connexion réussie!", role: "admin" });
    }
